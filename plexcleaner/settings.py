...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "webapp.context_processors.thresholds",
            ],
        },
    },
]
...
IMDB_RATING_THRESHOLD_MOVIES = float(os.getenv("IMDB_RATING_THRESHOLD_MOVIES", str(IMDB_RATING_THRESHOLD)))
IMDB_RATING_THRESHOLD_SERIES = float(os.getenv("IMDB_RATING_THRESHOLD_SERIES", str(IMDB_RATING_THRESHOLD)))
POPULARITY_THRESHOLD = float(os.getenv("POPULARITY_THRESHOLD", "10"))
